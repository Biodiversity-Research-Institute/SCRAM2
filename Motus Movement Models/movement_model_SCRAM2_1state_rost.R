...
N <- 145 #hard-coded (needs manual update)!
...
saveRDS(occup_BOEM_halfdeg_grid_aea_sf, file.path('P:', 'SCRAM', 'BRI', 'Integrated Movement Models', 'occup_BOEM_halfdeg_grid_aea_sf_rost_motus3.RDS')) #hard-coded (needs manual update)!

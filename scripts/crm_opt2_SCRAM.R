...
#'
#' Modified:
#' 26 Jan 2024 - ATG: made yinc a variable in calc of get_prop_crh_fhd_SCRAM so need to call this function to call it
#' 
#' @description
...
crm_opt2_SCRAM <- function(d_y,
  ...
  prop_chr_fhd <- get_prop_crh_fhd_SCRAM(d_y)

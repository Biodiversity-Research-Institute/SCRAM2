...
#' 
#' Modified:
#' 26 Jan 2024 - ATG: made yinc a variable, replacing 0.05 in calculation of average collision risk integral
#'
...
#'
#' @export
get_collisions_extended_SCRAM <- function(rotor_grids,
                                    d_y,
                                    rotor_radius,
                                    blade_width,
                                    rotor_speed,
  ...
  #calculate the yinc value from the number of fhd bands
  yinc <- 1/((y_lt - 1)/2)

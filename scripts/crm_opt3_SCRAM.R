...
#'
#' Modified:
#' 26 Jan 2024 - ATG: made yinc a variable in get_Collisions_extended, so now calling the SCRAM version to fix until 
#' fixed in stochLAB
#' 
#' @description
...
#' @inheritParams get_collisions_extended_SCRAM
#'
...
#'   )
#'
crm_opt3_SCRAM <- function(rotor_grids,
                     d_y_gen,
                     rotor_radius,
                     blade_width,
                     rotor_speed,
